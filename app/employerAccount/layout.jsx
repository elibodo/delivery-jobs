        ...
        <aside className="flex-1 mr-5">
          <nav>
            <ul className="relative grid gap-3">
              ...
              <li>
                <ProfileNavLink href={"/employerAccount/billing"}>
                  Billing
                </ProfileNavLink>
              </li>
              <li>
      ...
      <div className="md:hidden">
        <nav>
          <ul className="grid grid-flow-col justify-stretch h-[32px]">
            <li>
              <MobileNavLink href={"/employerAccount/employerAccountHome"}>
            ...
            <li>
              <MobileNavLink href={"/employerAccount/createJob"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/employerAccount/employerMessaging"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/employerAccount/candidates"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/employerAccount/billing"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/employerAccount/employerSettings"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
