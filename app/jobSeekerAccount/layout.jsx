      ...
      <div className="md:hidden">
        <nav>
          <ul className="grid h-[32px] grid-flow-col justify-stretch">
            ...
            <li>
              <MobileNavLink href={"/jobSeekerAccount/jobSeekerJobs"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/jobSeekerAccount/jobSeekerMessaging"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/jobSeekerAccount/jobSeekerInfo"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
            ...
            <li>
              <MobileNavLink href={"/jobSeekerAccount/jobSeekerSettings"}>
                <div className="flex flex-col items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
